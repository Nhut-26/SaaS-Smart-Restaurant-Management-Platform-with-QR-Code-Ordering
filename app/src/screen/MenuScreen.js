...
const MenuScreen = ({ navigation }) => {
  const [menuItems] = useState([
    ...
    { id: '4', name: 'Nem Rán', price: 40000, category: 'Khai vị', description: 'Nem rán Hà Nội', image: 'https://via.placeholder.com/300x200' },
    { id: '5', name: 'Cơm Gà', price: 50000, category: 'Món chính', description: 'Cơm gà xối mỡ', image: 'https://via.placeholder.com/300x200' },
    ...
    { id: '8', name: 'Cà Phê', price: 20000, category: 'Nước uống', description: 'Cà phê đen/ sữa', image: 'https://via.placeholder.com/300x200' },
  ]);
